              ...
              <div className="col-span-2 sm:col-span-1">
                <div className="sticky top-32 z-50">
                  ...
                  <p className="mt-4 text-zinc-400">
                    ...
                    Leveraging modern front-end frameworks like <span className="font-bold tracking-tight text-zinc-100">{` React,js `}</span> 
                    and <span className="font-bold tracking-tight text-zinc-100">{` Vue.js `}</span>, 
