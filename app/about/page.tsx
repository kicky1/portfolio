          ...
          <div className="grid grid-cols-2 gap-12">
            <div className="col-span-2 lg:col-span-1">
              ...
              <p className="mt-4 text-zinc-400">
                ...
                productive communication to understand their requirements and create 
                <span className="font-bold tracking-tight text-zinc-100">{` UI/UX designs `}</span>  that align 
              ...
              <p className="mt-4 text-zinc-400">
                ...
                such as expolring new technologies to stay updated with the latest trends in 
                the <span className="font-bold tracking-tight text-zinc-100">{` tech world `}</span>, 
                traveling to find joy in discovering new places and experiencing 
            ...
            <div className="mt-4">
              <div className="col-span-12 px-4 space-y-6 lg:col-span-9">
                <div className="flex items-center justify-center col-span-12 space-y-12 relative px-4 col-span-8 space-y-8">
                  <div className=" max-w-md relative border border-zinc-100 before:absolute before:-bottom-2 before:-right-2 before:h-4 before:w-4 before:border-b before:border-zinc-100 before:border-r before:transition-all before:duration-300 before:ease-in-out after:absolute after:-top-2 after:-left-2 after:h-4 after:w-4 after:border-t after:border-l after:transition-all after:duration-300 after:ease-in-out hover:before:h-[calc(100%+16px)] hover:before:w-[calc(100%+16px)] hover:after:h-[calc(100%+16px)] hover:after:w-[calc(100%+16px)]">
            ...
            <div className="grid grid-cols-2 gap-12">
              <div className="col-span-2 lg:col-span-1">
                <div className="sticky top-32 z-50">
                  ...
                  <p className="mt-4 text-zinc-400">
                    Throughout my career, I have been involved in creating web applications 
                    that seamlessly blend functionality and aesthetics. 
                    Leveraging modern front-end frameworks like <span className="font-bold tracking-tight text-zinc-100">{` React `}</span> 
                    and <span className="font-bold tracking-tight text-zinc-100">{` Vue `}</span>, 
                    I take pride in delivering responsive and user-friendly applications 
                    that leave a lasting impact. Mainly the projects I have dealt with so far have been related to banking and cisco technology. 
                    The projects were related to setting up call centers, or managing employees.
                  </p>
                </div>
              </div>
              <div className="flex items-center justify-center col-span-2 lg:col-span-1">
                <div className="mt-4">
                  ...
                  <div className="mt-4 col-span-12 px-4 space-y-6 lg:col-span-9">
                    <a
                      href={'https://drive.google.com/file/d/1cA4euMvgoIW5I_JDiAa0qInc9-y9TQxv/view?usp=sharing'}
                      target="_blank"
          ...
          <div className="max-w-7xl mx-auto lg:mx-0">
            <div className="grid grid-cols-1 gap-12">
              <div className="col-span-1">
                  ...
                  <p className="mt-4 text-zinc-400">
                    Throughout my adventurous journey as a software developer, I have diligently acquired proficiency in 
