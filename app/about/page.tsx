        ...
        <div className="max-w-7xl mx-auto lg:mx-0">
          <div className="grid grid-cols-2 gap-12">
            <div className="col-span-2 lg:col-span-1">
              <h2 className="text-3xl font-bold tracking-tight text-zinc-100 sm:text-4xl">About me</h2>
              ...
              <p className="mt-4 text-zinc-400">
                When I'm not immersed in coding, I indulge in various interests and hobbies, such as expolring new technologies to stay updated with the latest trends in the <span className="font-bold tracking-tight text-zinc-100">{` tech world `}</span>, traveling to find joy in discovering new places and experiencing diverse cultures, playing the guitar as my way of relaxing and expressing creativity, maintaining an active lifestyle through regular gym workouts to keep myself energized, and enjoying sketching architectural designs in my spare time.
              </p>
            </div>
            <div className="col-span-2 lg:col-span-1">
              <div className="mt-4">
            ...
            <div className="col-span-2 lg:col-span-1">
              <div className="sticky top-32 z-10">
                ...
                <p className="mt-4 text-zinc-400">
                  ...
                  and <span className="font-bold tracking-tight text-zinc-100">{` Vue `}</span>, I take pride in delivering responsive and user-friendly applications that leave a lasting impact. Mainly the projects I have dealt with so far have been related to banking and cisco technology. The projects were related to setting up call centers, or managing employees.
                </p>
              </div>
            </div>
            <div className="flex items-center justify-center col-span-2 lg:col-span-1">
              <div className="mt-4">
                ...
                <div className="mt-4 col-span-12 px-4 space-y-6 lg:col-span-9">
                  <a href={"https://drive.google.com/file/d/1FVZSRuhZgJ1beVFkwVrIOaydOR_KvLo2/view?usp=sharing"} target="_blank" rel="noopener noreferrer" className="flex items-center font-medium text-zinc-100 hover:underline group">
        ...
        <div className="max-w-7xl mx-auto lg:mx-0">
          <div className="grid grid-cols-1 gap-12">
            <div className="col-span-1">
              ...
              <p className="mt-4 text-zinc-400">Throughout my adventurous journey as a software developer, I have diligently acquired proficiency in numerous programming languages, libraries, and frameworks. The following represent the ones I feel most at ease with.</p>
            </div>
