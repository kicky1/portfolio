...
export default async function ProjectsPage() {
	...
	const data = [
		...
		{title:'Bingo', web:'https://kith-bingo.vercel.app/', image:bingo.src, badge:[{name: 'Next.js 13'},{name: 'Typescript'}, {name: 'Zustand'}, {name: 'Shadcn'}, {name: 'Tailwind'}, {name: 'Clerk'}, {name: 'Drizzle'}, {name: 'Postgres'}], github:'https://github.com/kicky1/bingo', description:'Bingo is a simple web application that allows users to play bingo.'},
		...
		{title:'eTrener',image:'',  badge:[{name: 'Python3'}, {name: 'Tensorflow'}], github:'https://github.com/kicky1/eTrener2', description:`Engineering thesis - Image processing based athleets training support system.`},
		{title:'ActivityRecognition',image:'',  badge:[{name: 'Python3'}, {name: 'Tensorflow'}, {name:'React'}, {name:'Typescript'}, {name:'VGGNet16'}], github:'https://github.com/kicky1/ActivityRecognition', description:`Master thesis - AI system to recognize variability of conditions in the elderly.`},
	]
